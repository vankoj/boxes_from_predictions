...
# here simply by changing `PATH_TO_FROZEN_GRAPH` to point to a new .pb file.
...
# Example call:
# print(get_predictions_from_image(
#     os.path.join(CUR_DIR_PATH,  'my_model', 'frozen_inference_graph.pb'),
#     os.path.join(CUR_DIR_PATH, 'my_model', 'label_map.pbtxt'),
#     Image.open(os.path.join(CUR_DIR_PATH, 'predict.jpg'))))
